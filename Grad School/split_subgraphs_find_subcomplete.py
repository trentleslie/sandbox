...
for subgraph in subgraphs:
	...
	output_line = current_subgraph_number + '\t' + str(nx.number_of_nodes(current_subgraph)) + '\t' + str(number_of_species) + '\t' + str(nx.diameter(current_subgraph)) + '\t' + str(nx.average_clustering(current_subgraph)) + '\tNone\t' + str(list(current_subgraph.edges()))+ '\t' + str(list(current_subgraph.nodes())) + '\n'
